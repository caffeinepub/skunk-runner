...
export class Backend implements backendInterface {
    ...
    async getInflationData(arg0: CategoryRequest): Promise<InflationSeries> {
        if (this.processError) {
            try {
                const result = await this.actor.getInflationData(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getRegionalCategories(arg0: string): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRegionalCategories(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTopInflationSubcategories(arg0: string, arg1: bigint): Promise<Array<[string, number]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTopInflationSubcategories(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
